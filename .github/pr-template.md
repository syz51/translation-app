...
- [ ] Implement transcription caching (dedup same files)
- [ ] Add usage quotas per user
- [ ] Support for webhooks (instead of polling)
- [ ] Dashboard for monitoring costs
- [ ] Support for other transcription providers
